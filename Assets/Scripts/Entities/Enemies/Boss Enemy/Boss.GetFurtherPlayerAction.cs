...
namespace Asteroids.Entities.Enemies
{
    ...
    {
        public sealed class GetFurtherPlayerAction : IAction<BossState, IGoal<BossState>>
        {
            ...
            void IAction<BossState, IGoal<BossState>>.Visit<TActionHandleAcceptor>(ref TActionHandleAcceptor acceptor, BossState worldState)
                => acceptor.Accept(new Handle(FurtherDistanceToPlayer - Vector3.Distance(worldState.PlayerPosition, worldState.BossPosition)));
        }
    }
}